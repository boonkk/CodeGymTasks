...
public class Solution {
    ...
    public <T extends Item> T getProxy(Class original, Class... items){
        ...
        return (T) Proxy.newProxyInstance(original.getClassLoader(), interfaces.toArray(new Class[interfaces.size()]), new ItemInvocationHandler());
