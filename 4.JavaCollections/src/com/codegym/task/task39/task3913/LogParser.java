...
//        Set<String> users = new HashSet<>();
//        for (LogElement element : listLogsBetweenDates(after, before)) {
//            if (element.event.equals(Event.SEND_MESSAGE) && element.status.equals(Status.OK))
//                users.add(element.user);
//        }
//        return users;
//    }
...
//        Set<String> users = new HashSet<>();
//        for (LogElement element : listLogsBetweenDates(after, before)) {
//            if (element.event.equals(Event.ATTEMPT_TASK))
//                users.add(element.user);
//        }
//        return users;
//    }
...
//        Set<String> users = new HashSet<>();
//        for (LogElement element : listLogsBetweenDates(after, before)) {
//            if (element.event.equals(Event.ATTEMPT_TASK) && element.task == task)
//                users.add(element.user);
//        }
//        return users;
//    }
...
//        Set<String> users = new HashSet<>();
//        for (LogElement element : listLogsBetweenDates(after, before)) {
//            if (element.event.equals(Event.COMPLETE_TASK))
//                users.add(element.user);
//        }
//        return users;
//    }
...
//        Set<String> users = new HashSet<>();
//        for (LogElement element : listLogsBetweenDates(after, before)) {
//            if (element.event.equals(Event.COMPLETE_TASK) && element.task == task)
//                users.add(element.user);
//        }
//        return users;
//    }
...
//        Collections.sort(elements, (o1, o2) -> o1.date.compareTo(o2.date));
//        for (LogElement element : elements) {
//            if (element.user.equalsIgnoreCase(user) && element.event.equals(Event.ATTEMPT_TASK) && element.task == task) {
//                date = element.date;
//                break;
//            }
//        }
...
//        Collections.sort(elements, (o1, o2) -> o1.date.compareTo(o2.date));
//        for (LogElement element : elements) {
//            if (element.user.equalsIgnoreCase(user) && element.event.equals(Event.COMPLETE_TASK) && element.task == task) {
//                date = element.date;
//                break;
//            }
//        }
...
//        Set<Date> dates = new HashSet<>();
//        for (LogElement element : listLogsBetweenDates(after, before)) {
//            if (element.user.equalsIgnoreCase(user) && element.event.equals(Event.SEND_MESSAGE))
//                dates.add(element.date);
//        }
//        return dates;
//    }
...
//        for (LogElement element : listLogsBetweenDates(after, before)) {
//            if (element.task == task && element.event.equals(Event.ATTEMPT_TASK))
//                attemptCounter++;
//        }
...
//        int success = 0;
//        for (LogElement element : listLogsBetweenDates(after, before)) {
//            if (task == element.task && Event.COMPLETE_TASK.equals(element.event))
//                success++;
//        }
//        return success;
//    }
